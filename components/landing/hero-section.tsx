      ...
      <section className="bg-muted/50 dark:bg-background overflow-hidden">
        <div className="relative mx-auto max-w-5xl px-6 pt-28 lg:pt-24">
          <div className="relative z-10 mx-auto max-w-2xl text-center">
            <h1 className="text-balance capitalize text-4xl font-semibold md:text-5xl lg:text-6xl">
              Your business, in flow
            </h1>
            <p className="text-muted-foreground mx-auto my-8 max-w-2xl text-xl">
              Flowdr helps you manage and grow your business by organizing your
              stores, staff, sales, and suppliers—all in one dashboard.
            </p>
